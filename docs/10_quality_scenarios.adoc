...
| Robustez | Buen manejo de excepciones para mejorar la experiencia del usuario y el uso de pods para aumentar la robustez de los servers | Alta
| Usabilidad | La aplicación ha de ser intuitiva y de fácil manejo para gente de todo tipo de nivel | Alta
| Autogestión | Permitir a los usuarios crearse sus propios pods o que puedan elegir ellos qué servicio de pods usar | Media-Alta
| Eficiencia | La aplicación será lo más eficiente posible usando los menores recursos posibles | Media
| Transparencia | Todo el proyecto será visible | Bajo
|===
****
